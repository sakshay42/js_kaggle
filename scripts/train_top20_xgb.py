...
MODEL_DIR = PROJECT_ROOT / "models" / "xgboost" / "top20_xgb"
LOG_DIR = PROJECT_ROOT / "logs"

TRAIN_PATH = DATA_DIR / "train.parquet"
VALID_PATH = DATA_DIR / "valid.parquet"
REPORT_PATH = LOG_DIR / "train_top20_xgb_report.json"
...
def train_one(config, train_dm, valid_dm, valid_df, feature_cols):
    params = base_params()
...
def main():
    ...
    for config in PARAM_GRID:
        model, result = train_one(config, train_dm, valid_dm, valid_df, feature_cols)
